...
ActiveRecord::Schema.define(version: 2020_11_14_114141) do
  ...
  create_table "input_formats", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["buyer_id"], name: "index_input_formats_on_buyer_id"
  end
  ...
  add_foreign_key "input_formats", "buyers"
